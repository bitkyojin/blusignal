...
var xxx=null;
if(x=="1"){xxx="playstation-5-everything-you-need-to.html"}
if(x=="2"){xxx="the-great-health-benefits-of-drinking.html"}
if(x=="3"){xxx="4-natural-fat-burners-that-you-may-try.html"}
if(x=="4"){xxx="6-health-benefits-of-mangoes.html"}
if(x=="5"){xxx="the-secret-weapon-to-success-in-business.html"}
if(x=="6"){xxx="kim-kardashian-best-body-on-earth.html"}
a_to_ve[i].href="https://blusignal.blogspot.com/2019/07/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
